...
class TestFieldOverrideMongoPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ...
        ('no_overrides', 1, True, False): (59, 6, 13),
        ('no_overrides', 2, True, False): (191, 6, 84),
        ('no_overrides', 3, True, False): (697, 6, 335),
        ('ccx', 1, True, False): (59, 6, 13),
        ('ccx', 2, True, False): (191, 6, 84),
        ('ccx', 3, True, False): (697, 6, 335),
        ('ccx', 1, True, True): (48, 6, 13),
        ('ccx', 2, True, True): (135, 6, 84),
        ('ccx', 3, True, True): (480, 6, 335),
        ('no_overrides', 1, False, False): (59, 6, 13),
        ('no_overrides', 2, False, False): (191, 6, 84),
        ('no_overrides', 3, False, False): (697, 6, 335),
        ('ccx', 1, False, False): (59, 6, 13),
        ('ccx', 2, False, False): (191, 6, 84),
        ('ccx', 3, False, False): (697, 6, 335),
...
class TestFieldOverrideSplitPerformance(FieldOverridePerformanceTestCase):
    ...
    TEST_DATA = {
        ('no_overrides', 1, True, False): (59, 4, 9),
        ('no_overrides', 2, True, False): (191, 19, 54),
        ('no_overrides', 3, True, False): (697, 84, 215),
        ('ccx', 1, True, False): (59, 4, 9),
        ('ccx', 2, True, False): (191, 19, 54),
        ('ccx', 3, True, False): (697, 84, 215),
        ('ccx', 1, True, True): (61, 4, 13),
        ('ccx', 2, True, True): (193, 19, 84),
        ('ccx', 3, True, True): (699, 84, 335),
        ('no_overrides', 1, False, False): (59, 4, 9),
        ('no_overrides', 2, False, False): (191, 19, 54),
        ('no_overrides', 3, False, False): (697, 84, 215),
        ('ccx', 1, False, False): (59, 4, 9),
        ('ccx', 2, False, False): (191, 19, 54),
        ('ccx', 3, False, False): (697, 84, 215),
